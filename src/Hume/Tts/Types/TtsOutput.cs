...
public record TtsOutput
{
    ...
    public struct Timestamp
    {
        ...
        public static implicit operator TtsOutput.Timestamp(Hume.Tts.TimestampMessage value) =>
            new(value);
    }
    ...
    public struct Audio
    {
        ...
        public static implicit operator TtsOutput.Audio(Hume.Tts.SnippetAudioChunk value) =>
            new(value);
    }
}
