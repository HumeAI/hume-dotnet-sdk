...
[JsonConverter(typeof(LanguageModelType.LanguageModelTypeSerializer))]
[Serializable]
public readonly record struct LanguageModelType : IStringEnum
{
    ...
    internal class LanguageModelTypeSerializer : JsonConverter<LanguageModelType>
    {
        ...
        )
        {
            ...
            return new LanguageModelType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            LanguageModelType value,
            JsonSerializerOptions options
        )
        {
