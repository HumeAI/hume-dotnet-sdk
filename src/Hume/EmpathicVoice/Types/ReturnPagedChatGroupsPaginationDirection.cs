...
[JsonConverter(
    typeof(ReturnPagedChatGroupsPaginationDirection.ReturnPagedChatGroupsPaginationDirectionSerializer)
)]
[Serializable]
public readonly record struct ReturnPagedChatGroupsPaginationDirection : IStringEnum
{
    ...
    internal class ReturnPagedChatGroupsPaginationDirectionSerializer
        : JsonConverter<ReturnPagedChatGroupsPaginationDirection>
    {
        public override ReturnPagedChatGroupsPaginationDirection Read(
        ...
        )
        {
            ...
            return new ReturnPagedChatGroupsPaginationDirection(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ReturnPagedChatGroupsPaginationDirection value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ReturnPagedChatGroupsPaginationDirection ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
