...
[Serializable]
public record GroupedPredictionsProsodyPrediction : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<ProsodyPrediction> Predictions { get; set; } = new List<ProsodyPrediction>();
