...
[Serializable]
public record GroupedPredictionsLanguagePrediction : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<LanguagePrediction> Predictions { get; set; } =
        new List<LanguagePrediction>();
