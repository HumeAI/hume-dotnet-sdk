...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<HumeApi.Core.ApiResponse> MakeRequestAsync(
        HumeApi.Core.BaseRequest request,
    ...
    internal async Task<HumeApi.Core.ApiResponse> SendRequestAsync(
        HumeApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<HumeApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new HumeApi.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(HumeApi.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(HumeApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use HumeApi.Core.ApiResponse instead.")]
    internal record ApiResponse : HumeApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use HumeApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : HumeApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use HumeApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : HumeApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use HumeApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : HumeApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use HumeApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : HumeApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use HumeApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : HumeApi.Core.StreamRequest;
}
